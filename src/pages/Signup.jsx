      ...
      <div className="content">
        ...
        <div className="body flex column a-center j-center">
          <div className="text flex column">
            ...
            <h4>Watch anywhere. Casncel anytime</h4>
            <h6>Ready to watch? Enter your email to create or restart membership</h6>
          </div>
          <div className="form">
            <input type="email" placeholder="Email Adderss" name="email" value={formValues.email} onChange={(e)=>setFormValues({...formValues,[e.target.name]:e.target.value})}/>
            {
